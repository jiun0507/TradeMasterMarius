...
class BaseWindow:
    ...
    def _add_button(
        self, text, fg=None, bg=None, row=None, column=None, command=None, entry=None
    ):
        ...
        button = ttk.Button(
            self.root, fg=fg, bg=bg, text=text, command=composed_command
        )
...
class LandingWindow(BaseWindow):
    def __init__(self):
        ...
        self._add_label(
            text="Welcome to Marius Stocks", row=0, column=1, font=("Helvetica", 24)
        )
