            ...
            for fs in fs_list:
                ...
                try:
                    ...
                    financial_statement_vi = models.FinancialStatementValueInvestment(
                        ...
                        enterpriseValueOverEBITDA=fs.get(
                        ...
                        preferredDividendsIncomeStatementImpact=fs.get(
                            "preferredDividendsIncomeStatementImpact", None
                        ),
                        ...
                        weightedAverageSharesDiluted=fs.get(
                            "weightedAverageSharesDiluted", None
                        ),
                        salesPerShare=fs.get("salesPerShare", None),
                        tangibleAssetsBookValuePerShare=fs.get(
                            "tangibleAssetsBookValuePerShare", None
                        ),
                    )
                    financial_statement.financial_statement_value_investment = (
                        financial_statement_vi
                    )
                    session.add(financial_statement)
